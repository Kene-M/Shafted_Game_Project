...
func _create_weapons():
	var weapon_args = [
			...
			["Launcher", "res://Scripts/weaponScripts/weaponLogicScripts/launcher.gd", [3,3,2,1,1], "Ranged"],
			...
			["Hammer", "res://Scripts/weaponScripts/weaponLogicScripts/hammer.gd", [3,2,2,2,1], "Melee"]
		]
